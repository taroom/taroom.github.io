...
Materi belajar integrasi Golang dengan MySQL.

1. [Setup koneksi Go dan MySQL](1.setup-koneksi-go-mysql.md)
2. [Membuat model dan repository](2.model-dan-repository.md)
